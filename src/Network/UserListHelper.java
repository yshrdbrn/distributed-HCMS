...
{
  private static String  _id = "IDL:Network/UserList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (Network.UserListHelper.id (), "UserList", __typeCode);
    }
    return __typeCode;
  }

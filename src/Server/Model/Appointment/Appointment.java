...
public class Appointment implements Comparable<Appointment> {
    ...
    public Appointment(Network.Appointment appointment) {
        ...
        switch (appointment.type.value()) {
            ...
            case Network.AppointmentType._DENTAL:
                ...
                break;
            case Network.AppointmentType._NONE:
    ...
    public Network.Appointment ToNetworkAppointment() {
        Network.Appointment toRet = new Network.Appointment();

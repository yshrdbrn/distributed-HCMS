...
public class Appointment implements Serializable {
    ...
    public static Model.Appointment.Appointment toGeneralAppointment(Appointment appointment) {
        AppointmentID appointmentID = new AppointmentID(appointment.getID());
